  ...
  return (
    <div className="relative bg-cover bg-center h-[40vh] md:h-[80vh]" style={{ backgroundImage: `url('/h.jpg')` }}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4">
        ...
        <p className="text-white text-sm md:text-lg mb-4 text-center capitalize">Well come to the ehsas lab COMMUNITY </p>
        <div className="w-full max-w-md flex flex-col md:flex-row items-center">
          ...
          />
          <button className="border duration-1000 hover:bg-[#3d9b05] text-white px-4 py-2 rounded md:rounded-l-none w-full md:w-auto">
            SUBSCRIBE
          </button>
        </div>
      </div>
