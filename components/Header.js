            ...
            <div className="h-[49px] flex justify-center gap-x-10 items-center">
              <div className=" relative px-2 flex items-center ">
               <a href="/" className="md:flex block md:gap-x-1">
                ...
                {toogle ?
                 // absolute top-[70px]left-[-1.5rem]

                    <ul className="flex-col gap-y-6 z-50 border-t-2 border-gray-400 px-11 mt-2.5  w-[150px]  bg-black items-center md:hidden  md:font-bold">
