               ...
               <a href="/" className="md:flex block md:gap-x-1">
                ...
                {toogle ?
                 // 
                    ...
                    <ul className="flex-col gap-y-6 z-50 border-t-2 border-gray-400 px-11 absolute top-[70px] left-[-1.5rem]  w-[150px]  bg-black items-center md:hidden  md:font-bold">
