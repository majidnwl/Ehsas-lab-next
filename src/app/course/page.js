        ...
        <div>
            ...
            <div className="relative bg-cover bg-center md:bg-top h-[40vh] md:h-[20vh]" style={{ backgroundImage: `url('/h.jpg')` }}>
                ...
                <div className=" md:mt-5">
                    ...
                    <div className="card-inner  p-4 text-gray-900 shadow-lg bg-gray-100">
                        <i><h1 className='text-center font-bold text-2xl text-black'>Course Introduction</h1>
                        </i>
                            ...
                            <div className="flex-1 md:mt-0 mt-4">
                                ...
                                <div className="flex items-center mb-1">
                                    ...
                                    <div className="text-sm">
                                        <p className="leading-none">Amanda Ergony</p>
